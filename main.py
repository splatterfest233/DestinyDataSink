...
user_name = 'splatterfest233'  # put name of person whose info/clan you want to explore
user_platform = 'xbox'  # either 'psn' or 'ps4' or 'xbone' or 'xbox'  (pc is busted)
save_to_file = 0  # flag: set to 1 if you want certain bits saved to file to peruse

# %% fixed parameters
my_api_key = "c8e47472d649412a97963be6dc9af0d8"
...
def get_activity_history_url(user_name, user_platform, character_id, \
    ...
    """Returns useful history of activities, filtered by type if you want (e.g.,
